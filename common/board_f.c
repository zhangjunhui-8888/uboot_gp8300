...
# if defined(CONFIG_HW_WATCHDOG) && (defined(CONFIG_BLACKFIN) || \
	...
	defined(CONFIG_IMX_WATCHDOG) || defined(CONFIG_GPT_WATCHDOG))
	hw_watchdog_init();
# endif
...
#endif
#ifdef CONFIG_GPT
	/* round down to next 64 kB to satisfy the taddpcil and aaddpcilb instruction */
	gd->relocaddr &= ~(65536 - 1);
#endif
...
#if !defined(CONFIG_ARM) && !defined(CONFIG_SANDBOX) && \
		!defined(CONFIG_EFI_APP) && !defined(CONFIG_GPT)
