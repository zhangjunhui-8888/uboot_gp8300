...
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    "update_uboot=erase 1:0-0xc0 && norfl write ${loadaddr} 0 c0000\0" \
    "nfsargs=run set_nfs; run setbaseargs; setenv bootargs ${baseargs} ${arg_nfs}\0"   \
    "gp8300_evk_bootargs=setenv bootargs ${bootargs}\0"   \
    "tftpbootz=run gp8300_evk_bootargs;tftp ${bootz_addr} zImage && bootz ${bootz_addr}\0" \
    "tftpbootm=run gp8300_evk_bootargs;tftp ${bootm_addr} gpt_gp8300_evk.itb && bootm ${bootm_addr}\0" \
    ...
    "tftp_itb_sd=run nfsargs; tftp ${bootm_addr} gpt_gp8300_evk.itb && ext4write mmc 0:1 ${bootm_addr} /gpt_gp8300_evk.itb $filesize\0" \
    ...
    "boot_itb_sd=run gp8300_evk_bootargs;mmc rescan; ext4load mmc 0:1 ${bootm_addr} /gpt_gp8300_evk.itb && bootm ${bootm_addr}\0" \
    "boot_sd_fat=mmc rescan; fatload mmc 0:1 ${loadaddr} /vmlinux.bin && go ${loadaddr}\0" \
	"picture_path=/HXGPT_720P.yuv\0"	\
    "fill_logo=ext4load mmc 0:2 ${showaddr} ${picture_path} \0" \
    "init_vdo=vdo clk_sel=3 init clk_delay=0 mode 24 \0" \
    "wdt_timeout=30 \0" \
...
#if 0
#define CPLL_FREQ			0		
#define CONFIG_BAUDRATE			0		
#define CPLL_FREQ_1992M
/*#define CPLL_FREQ_1500M*/
/*#define CPLL_FREQ_1248M*/
#ifdef CPLL_FREQ_1992M
#undef CPLL_FREQ		
#undef CONFIG_BAUDRATE	
#define CPLL_FREQ			(1992 * MHz)
#elif defined(CPLL_FREQ_1500M)
#undef CPLL_FREQ		
#undef CONFIG_BAUDRATE	
#define CPLL_FREQ			(1500 * MHz)
#if 0
#define CONFIG_BAUDRATE			9637
#endif 
#elif defined(CPLL_FREQ_1248M)
#undef CPLL_FREQ		
#undef CONFIG_BAUDRATE	
#define CPLL_FREQ			(1248 * MHz)
#if 0
#define CONFIG_BAUDRATE			115200	
#endif
#endif
...
#define CONFIG_GPT_DDR_MODE		DDR_1600
