...
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    "gp8300_chaokong_bootargs=setenv bootargs ${bootargs}\0"   \
    "tftpbootz=run gp8300_chaokong_bootargs;tftp ${bootz_addr} zImage && bootz ${bootz_addr}\0" \
    "tftpbootm=run gp8300_chaokong_bootargs;tftp ${bootm_addr} gpt_gp8300_chaokong.itb && bootm ${bootm_addr}\0" \
    ...
    "tftp_itb_sd=run nfsargs; tftp ${bootm_addr} gpt_gp8300_chaokong.itb && ext4write mmc 0:1 ${bootm_addr} /gpt_gp8300_chaokong.itb $filesize\0" \
    ...
    "boot_itb_sd=run gp8300_chaokong_bootargs;mmc rescan; ext4load mmc 0:1 ${bootm_addr} /gpt_gp8300_chaokong.itb && bootm ${bootm_addr}\0" \
