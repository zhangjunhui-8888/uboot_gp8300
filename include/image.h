...
#if defined(CONFIG_TARGET_GP8300_EVK)
#include "configs/gp8300_evk.h"
#endif

#if defined(CONFIG_TARGET_GP8300_DVB)
#include "configs/gp8300_dvb.h"
#endif

#if defined(CONFIG_TARGET_GP8300_CHAOKONG)
#include "configs/gp8300_chaokong.h"
#endif
...
#define uimage_to_cpu_l(x)		be64_to_cpu(x)
#define cpu_to_uimage_l(x)		cpu_to_be64(x)
/*
...
#define image_get_hdr_ll(f) \
	...
	{ \
		return uimage_to_cpu_l(hdr->ih_##f); \
	}
