...
#ifndef ADV7612_HDMI_MAP_FCT_H
#define ADV7612_HDMI_MAP_FCT_H
...
#define VRX_is_FORCE_YCRCB_444_true()                       ATV_I2CIsField8(VRX_HDMI_MAP_ADDR, 0x46, 0x10, 0x4)
#define VRX_get_FORCE_YCRCB_444(pval)                       ATV_I2CGetField8(VRX_HDMI_MAP_ADDR, 0x46, 0x10, 0x4, pval)
#define VRX_ret_FORCE_YCRCB_444()                           ATV_I2CReadField8(VRX_HDMI_MAP_ADDR, 0x46, 0x10, 0x4)
#define VRX_set_FORCE_YCRCB_444(val)                        ATV_I2CWriteField8(VRX_HDMI_MAP_ADDR, 0x46, 0x10, 0x4, val)

#define VRX_is_FORCE_YCRCB_422_true()                       ATV_I2CIsField8(VRX_HDMI_MAP_ADDR, 0x47, 0x10, 0x4)
#define VRX_get_FORCE_YCRCB_422(pval)                       ATV_I2CGetField8(VRX_HDMI_MAP_ADDR, 0x47, 0x10, 0x4, pval)
#define VRX_ret_FORCE_YCRCB_422()                           ATV_I2CReadField8(VRX_HDMI_MAP_ADDR, 0x47, 0x10, 0x4)
#define VRX_set_FORCE_YCRCB_422(val)                        ATV_I2CWriteField8(VRX_HDMI_MAP_ADDR, 0x47, 0x10, 0x4, val)
...
#define VRX_is_MUX_SPDIF_TO_I2S_ENABLE_true()               ATV_I2CIsField8(VRX_HDMI_MAP_ADDR, 0x6E, 0x8, 0x3)
#define VRX_get_MUX_SPDIF_TO_I2S_ENABLE(pval)               ATV_I2CGetField8(VRX_HDMI_MAP_ADDR, 0x6E, 0x8, 0x3, pval)
#define VRX_ret_MUX_SPDIF_TO_I2S_ENABLE()                   ATV_I2CReadField8(VRX_HDMI_MAP_ADDR, 0x6E, 0x8, 0x3)
#define VRX_set_MUX_SPDIF_TO_I2S_ENABLE(val)                ATV_I2CWriteField8(VRX_HDMI_MAP_ADDR, 0x6E, 0x8, 0x3, val)
...
#define VRX_get_DDC_PWRDN(pval)                             ATV_I2CGetField8(VRX_HDMI_MAP_ADDR, 0x73, 0xFF, 0, pval)
#define VRX_ret_DDC_PWRDN()                                 ATV_I2CReadField8(VRX_HDMI_MAP_ADDR, 0x73, 0xFF, 0)
#define VRX_set_DDC_PWRDN(val)                              ATV_I2CWriteField8(VRX_HDMI_MAP_ADDR, 0x73, 0xFF, 0, val)
