...
* DATE: 10 Aug 2010 11:2:29                                                    *
*                                                                              *
*******************************************************************************/


#ifndef ADV7612_IO_MAP_FCT_H
#define ADV7612_IO_MAP_FCT_H
...
#define VRX_is_CP_COMPLETE_BYPASS_IN_HDMI_MODE_true()       ATV_I2CIsField8(VRX_IO_MAP_ADDR, 0xBF, 0x1, 0x0)
#define VRX_get_CP_COMPLETE_BYPASS_IN_HDMI_MODE(pval)       ATV_I2CGetField8(VRX_IO_MAP_ADDR, 0xBF, 0x1, 0x0, pval)
#define VRX_ret_CP_COMPLETE_BYPASS_IN_HDMI_MODE()           ATV_I2CReadField8(VRX_IO_MAP_ADDR, 0xBF, 0x1, 0x0)
#define VRX_set_CP_COMPLETE_BYPASS_IN_HDMI_MODE(val)        ATV_I2CWriteField8(VRX_IO_MAP_ADDR, 0xBF, 0x1, 0x0, val)
