...
#if defined(CONFIG_TARGET_GP8300_FPGA) || defined(CONFIG_TARGET_GP8300_EVK) 
	val |= CLK_1_EN;
#elif defined(CONFIG_TARGET_GP8300_DVB) || defined(CONFIG_TARGET_GP8300_CHAOKONG)
	val |= CLK_0_EN;
#endif
